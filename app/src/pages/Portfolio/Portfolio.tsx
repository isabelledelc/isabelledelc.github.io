      ...
      <main className="mx-auto max-w-6xl px-4 pb-16 pt-8">
        ...
        {activeTab === "Holdings" ? (
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 gap-6 md:grid-cols-12">
              <div className="md:col-span-5 flex flex-col justify-between rounded-3xl border border-[var(--border-app)] bg-[var(--bg-container)] p-6 shadow-xs backdrop-blur-md">
                <div className="my-8 text-center">
                  <h3 className="text-2xl font-extrabold text-[var(--text-heading)]">Account Name</h3>
                  <p className="mt-2 text-base font-semibold text-[var(--text-muted)]">Account Number</p>
                </div>
              </div>
