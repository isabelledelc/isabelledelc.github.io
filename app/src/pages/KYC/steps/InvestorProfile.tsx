      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-[#E9F7E5]/50 p-6 rounded-3xl border border-emerald-100">
        ...
        <div className="space-y-1">
          ...
          <select
            ...
            className="w-full bg-white border border-emerald-500 rounded-2xl p-4 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500"
          >
            <option value="">My age is between...</option>
        ...
        <div className="space-y-1">
          ...
          >
            <option value="">My primary investment objective is...</option>
        ...
        <div className="space-y-1">
          ...
          <select
            ...
            className="w-full bg-white border border-slate-300 rounded-2xl p-4 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500"
          >
            <option value="">I tend to invest for...</option>
        ...
        <div className="space-y-1">
          ...
          <select
            ...
            className="w-full bg-white border border-slate-300 rounded-2xl p-4 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500"
          >
            <option value="">My annual income from all sources is...</option>
